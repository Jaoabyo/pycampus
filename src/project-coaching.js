...
export const calculatorCoaching = {
  ...
  saldo: ['Calcule quanto sobra da renda depois das despesas. Mostre com duas casas decimais.', 'O desconto das despesas usa soma ou subtração? Por quê?', ['Use a renda e o total que você já calculou. Guarde o resultado em saldo.', 'Para mostrar casas decimais, um exemplo com outro valor é print(f"{preco:.2f}"). O formato muda a aparência, não a conta.']],
  ...
  relatorio: ['Mostre renda, despesas e saldo, cada um em uma linha com seu nome e duas casas.', 'Se o saldo for negativo, isso é um erro de Python ou pode ser um resultado válido do orçamento?', ['Use três prints, cada um mostrando uma das variáveis que você já calculou.', 'Na f-string, o nome que você quer mostrar fica fora das chaves. Exemplo de outra situação: print(f"Preço: {preco:.2f}").']]
};
