...
export default function App() {
  ...
  function Dashboard() {
    ...
    const abrirMissao = item => { if (item.kind === 'lesson') openLesson(item.id); else if (item.kind === 'practice') navigate('practice'); else if (item.kind === 'project') openProject(item.id); else navigate('targeted'); };
