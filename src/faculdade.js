...
export const aulasDaFaculdade = [
  ...
  aula('r2', 'Repetições: for, while, range, break e continue', 'u1',
    ...
    'Percorra as notas [5, 4, 3, 2, 1] com for e mostre somente a soma.',
  ...
  aula('u2a1', 'Estruturas de dados I: sequências, listas e tuplas', 'u2',
    ...
    'A tupla dias, com "seg", "ter" e "qua", já está criada. Mostre o tamanho dela, depois percorra com enumerate mostrando "0 seg", "1 ter" e "2 qua", um por linha.',
  ...
  aula('r4', 'Web: front-end, back-end e Python', 'u4',
    ...
    'O dicionário camadas, com front-end igual a HTML e back-end igual a Flask, já está pronto. Mostre uma linha para cada camada exatamente como na saída esperada.',
  ...
  aula('u4a3', 'Testes com Python: assert, doctest e unittest', 'u4',
    'Testes verificam automaticamente se o comportamento observado coincide com o esperado. Um bom conjunto inclui o caso comum, limites, entradas vazias e situações de erro.|assert interrompe a execução quando uma condição é falsa. É útil para exercícios e verificações internas, mas não substitui validação de entrada em produção porque pode ser desativado pelo modo otimizado do Python.|doctest executa exemplos escritos na documentação com o marcador >>> e compara o resultado. Isso mantém exemplos e código sincronizados.|unittest organiza testes em classes que herdam de unittest.TestCase. Cada método começa com test_ e usa verificações como assertEqual. unittest.main() descobre e executa os testes. No notebook, use unittest.main(argv=[\'\'], exit=False): argv=[\'\'] evita que ele tente ler os argumentos do Colab, e exit=False não encerra o ambiente.|Nos arquivos de teste é comum terminar com if __name__ == "__main__": e unittest.main(). Quando você executa o arquivo direto, o Python chama esse arquivo de __main__ e os testes rodam. Quando outro arquivo o importa, o nome muda e os testes não rodam sozinhos. A classe que herda de unittest.TestCase organiza os testes de uma função; o assertEqual vem do TestCase.',
