...
export default function HistoryView({ state, update, download }) {
  ...
  return <>
    ...
    {!shown.length && <section className="card empty"><Icon name="Sprout" size={26} /><h3>{items.length ? 'Nenhuma tentativa neste filtro' : 'Seu próximo teste já pode entrar no diário'}</h3><p>Execute um programa no laboratório ou em uma aula. Ele aparecerá aqui quando terminar ou for interrompido.</p></section>}
