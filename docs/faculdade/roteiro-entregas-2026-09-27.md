...
| 3 | Análise de vendas | SQLite, pandas, manipulação e visualização | banco reproduzível, análises, gráficos, três insights e sugestões |
...
5. Na Unidade 4, copie para o PyCampus a acurácia e as predições realmente observadas e registre a data. A prática local não substitui a rede TensorFlow.
6. Salve uma cópia final do notebook com as células executadas.
